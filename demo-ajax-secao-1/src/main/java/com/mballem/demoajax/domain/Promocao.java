...
public class Promocao implements Serializable {
	...
	@Id 
	@SequenceGenerator(name = "promocoes_id_seq", sequenceName = "promocoes_id_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "promocoes_id_seq")
	@Column(name = "id", updatable = false)
	private Long id;
	
	@NotBlank(message = "Um titulo e requerido.")
	@Column(name = "titulo", nullable = false)
	private String titulo;
	
	@NotBlank(message = "O link da promocao e requerido.")
